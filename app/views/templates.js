...
<header class="mobile-header">
  ...
  <h1>POS System</h1>
  <div id="mobile-user-info" class="mobile-user-info"></div>
</header>`,
...
<aside id="sidebar" class="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <button class="nav-item" data-page="caisse">
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <button class="nav-item admin-only" data-page="users">
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <button class="nav-item admin-only" data-page="settings">
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <button class="nav-item admin-only" data-page="categories">
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
  ...
  <div class="sidebar-footer">
    <div class="user-info">
      ...
      <div class="user-details">
        ...
        <span class="user-role" id="user-role-display">Administrateur</span>
      </div>
    </div>
  ...
  <div class="caisse-container">
    <div class="caisse-products">
      <div class="search-bar">
        ...
        <input type="text" id="product-search" placeholder="Rechercher un produit ou scanner...">
      </div>
      <div id="products-loading" class="loading-spinner hidden">
    ...
    <div class="caisse-cart">
      <div class="cart-header">
        <h3>Panier</h3>
        <button id="clear-cart" class="btn btn-ghost btn-small">
      ...
      <button id="validate-sale" class="btn btn-primary btn-full" disabled>
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
<div id="page-history" class="page">
  ...
  settings: `
<!-- Settings Page -->
<div id="page-settings" class="page admin-only">
  <div class="page-header">
    <h2>Paramètres</h2>
  </div>
